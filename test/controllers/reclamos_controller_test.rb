...
class ReclamosControllerTest < ActionController::TestCase
  ...
  test "should create reclamo" do
    ...
    assert_difference('Reclamo.count') do
      post :create, reclamo: { descripcion: @reclamo.descripcion, fecha: @reclamo.fecha, imagen: @reclamo.imagen, tipo_reclamo_id: @reclamo.tipo_reclamo_id, titulo: @reclamo.titulo, ubicacion: { latitud: @ubicacion.latitud, lonitud: @ubicacion.longitud } , user_id: @reclamo.user_id }
    end
