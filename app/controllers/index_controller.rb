class IndexController < ApplicationController
  ...
  def index
  	...
  	@reclamos_destacados = Reclamo.select("reclamos.*, count(reclamos.id) as valoracion").joins('LEFT JOIN reclamo_usuarios ON reclamos.id = reclamo_usuarios.reclamo_id')
